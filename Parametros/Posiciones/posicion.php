...
function editar_pos($id, $nuevo, $emp){
	...
	$sql="UPDATE posicion SET Posicion='{$nuevo}', IdEmpresa='{$emp}' Where Id='{$id}'";
	$res=mysql_query($sql);

	$js="$('#tabla_pos').load('tabla.php');$('#Modal_editar').modal('hide');";
	$objResp->script($js);
...
$xajax->registerFunction("editar_pos");
$xajax->registerFunction("eliminar_pos");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  ...
  <script>
	...
	function editar(id, nom, emp){
		...
		document.getElementById('Pos_edit').value=nom;
		//alert(emp);
	...
	function eliminar(id, nom){
		...
		bootbox.confirm({
	    title: "Eliminar ",
	    message: "Eliminar Posicion <strong>"+nom+"</strong> ?",
	    closeButton: false,
	    buttons: {
	        cancel: {
	            label: 'Cancelar'
...
<body>
    ...
    if($_POST[Guardar]){
    	...
    	$sql="INSERT INTO posicion (Posicion,IdEmpresa) VALUES ('$_POST[nombre]','$_POST[Empresa]')";
    	//echo $sql;
    	$res=mysql_query($sql);
		...
		<form class="form-horizontal" role="form"  id="formu" name="formu" method="post">
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-3">
						<input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre de Posicion">
						</div>
						<div class="col-sm-3">
			...
			<div id="tabla_pos" style="display:block">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Editar Posiciones</h4>
      </div>
			   ...
			   <div id="Editar" name="Editar" > 
		           <div class="form-group  has-feedback">
		              ...
		              <div class="col-sm-3">
		                ...
		                <input name="Pos_edit" id="Pos_edit" type="text" class="form-control"  value="" placeholder="Nombre de Posicion">
      ...
      <input name="oculto" id="oculto" type="hidden" class="form-control col-sm-2"  value="<? echo $_POST['oculto']?>" >
        ...
        <button type="button" class="btn btn-primary" value="Listo" id="Listo" name="Listo"  onclick="return editar_nombre(oculto.value,Pos_edit.value, Empresa_edit.value)">Listo</button>
      </div>
    </div>
  </div>
</div>
