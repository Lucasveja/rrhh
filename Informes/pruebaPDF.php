...
<html lang="en">
<head>
  <title>Developsys/Informes Evaluado Simple</title>
...
session_start(); 
 ...
 $content ="<page backtop='115mm'><page_header>

 			<table width='900' border='0' cellpadding='0' cellspacing='0' align='center'>
 				<tr>
 					<td ><p align='center'>EVALUACI&Oacute;N DE DESEMPE&Ntilde;O PERSONAL NORMAL</p></td>
 					
 			    </tr>
 			    <tr>
 			    <td ><p align='center'>JORNALIZADO-{$año} </p></td>
 			    </tr>
 			</table>   
			<br>
 			...
 			<table align='left' border='0' width='100%' cellpadding='0' cellspacing='0'>
 				<tr>
 					...
 					<td width='300'><b>{$evaluado[Nombre]}</b></td>
			...
			<table align='left' border='0' width='100%' cellpadding='0' cellspacing='0'>
			  ...
			  <tr>
 					<td width='20' height='24' style='font-size: 14px'>Nombre:</td>
 					<td><b>{$evaluador[Nombre]}</b></td>
 					
 				</tr>
			  
			  <tr>
				<td width='20' height='24' style='font-size: 14px'>Legajo: </td>
				<td><b>{$evaluador[Legajo]}</b></td>
			  ...
			  <tr>
			  ...
			  </tr></table></page_header></page><page>"; 
                     
     
			   $sqlComp="SELECT * FROM competencias group by subtitulo order by competencia;";				
				$ruslt=query($sqlComp);
			    foreach ($ruslt->rows as $read){
				   ...
				   $content.="<table border='0'  height='60' width='100%' cellpadding='0' cellspacing='0'> 
						...
						foreach ($rusltSub->rows as $competencia) 
						{
							 //DATOS DE MOVIMIENTOS
							  $sqlMov="select * from movimientos WHERE IdEmpresa='{$_GET[empresa]}' and IdEvaluador='{$_GET[evaluador]}' and IdEvaluado='{$_GET[evaluado]}' and Periodo='{$peri}' and competencia='{$competencia[competencia]}'";
			     ...
			     $content.="
			    		<table align='center' border='0' height='60' width='100%' cellpadding='0' cellspacing='0'>
			    			<tr style='text-align:center'>
			    				<td width='750' height='25'><p>Esta evaluación general tiene por objeto resumir la opinión sobre el evaluado. Representa la síntesis conceptual de los rubros evaluados anteriormente.</p></td>
			    			</tr></table><br>";
			    ...
			    $sqlDesemp="SELECT * from desempenio where idempresa='{$_GET[empresa]}' and idevaluador='{$_GET[evaluador]}' and periodo='{$peri}' and idevaluado='{$_GET[evaluado]}'";
				 ...
				 $content.="
			    		<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><table align='center' border='0' height='60' width='100%' cellpadding='0' cellspacing='0'>
			    			<tr style='text-align:center'>
			    ...
			    $content.="
			    		<table align='center' border='0' height='60' width='100%' cellpadding='0' cellspacing='0'>
			    			...
			    			<tr>
			    				<td width='750' height='25'><p>1)</p></td>
			    			</tr>
			    			<tr>
			    				<td width='750' height='25'><p>2)</p></td>
			    			</tr>
			    			<tr>
			    				<td width='750' height='25'><p>3)</p></td>
			    			</tr></table><br>";
			     $content.="
			    		<table align='center' border='0' height='60' width='100%' cellpadding='0' cellspacing='0'>
			    			<tr>
			   ...
			   $content.="
				 ...
				 $content.="<br><br><br><br><br><table border='0'  height='60' width='100%' cellpadding='0' cellspacing='0'> 
						  <tr>
							<td width='190' ><b>FECHA:</b></td>
