      ...
      <ul class="nav navbar-nav">
            ...
            if(($_SESSION['autenticado'] == 'SI')  && isset($_SESSION['uid'])){ ?>
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                      ...
                      <li><a href="/arcorsj/apps/rrhh/Parametros/Empresas/empresa.php">Empresas&nbsp;<span class="icon-list2 pull-right"></a></li>
                      <li><a href="/arcorsj/apps/rrhh/Parametros/Departamentos/departamento.php">Departamentos&nbsp;<span class="icon-list2 pull-right"></a></li>
                      <li><a href="/arcorsj/apps/rrhh/Parametros/Area/area.php">Areas&nbsp;<span class="icon-list2 pull-right"></a></li>
                      <li><a href="/arcorsj/apps/rrhh/Parametros/Posiciones/posicion.php">Posicion&nbsp;<span class="icon-price-tags pull-right"></a></li>
                      <li><a href="/arcorsj/apps/rrhh/Parametros/Evaluados/evaluado.php">Evaluados&nbsp;<span class="icon-clipboard pull-right"></a></li>
                      <li><a href="/arcorsj/apps/rrhh/Parametros/Evaluadores/evaluador.php">Evaluadores&nbsp;<span class="icon-clipboard pull-right"></a></li>
                      ...
                      <li><a href="/arcorsj/apps/rrhh/Parametros/Asignados/asignar.php">Asignados&nbsp;<span class="icon-clipboard pull-right"></a></li>
       ...
       //                       INFORMES
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
             <li><a href="/arcorsj/apps/rrhh/Informes/Informe.php" title="Informe Presentacion PDF">PDF<span class="glyphicon glyphicon-list-alt pull-right"></span></a></li>
<li><a href="/arcorsj/apps/rrhh/Informes/EvaluacionHistorial.php" title="Evaluacion Historial">Historial Evaluacion<span class="glyphicon glyphicon-list-alt pull-right"></span></a></li>
