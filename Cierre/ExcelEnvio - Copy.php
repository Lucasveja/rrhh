...
?>
<?php
$cn = mysql_connect("localhost", "root", "KhyWKHIR9U47");
...
$sqlMov="Select legajo,nombre,e.id,depto,posicion,area,m.idevaluado from movimientos m inner join evaluado e on m.idempresa=e.idempresa and m.idevaluado=e.id inner join departamentos d on
